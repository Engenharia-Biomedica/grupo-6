...
bacteria_df = df[(df['ds_micro_organismo'] == 'Streptococcus pneumoniae') & (df['cd_interpretacao_antibiograma'] == 'Resistente')]
st.title("Gráficos específico para Streptococcus Pneumoniae Resistente")
...
bacteria_g = g[(g['ds_micro_organismo'] == 'Streptococcus pneumoniae') & (g['cd_interpretacao_antibiograma'] == 'Resistente')]
st.title("Presença de Streptococcus Pneumoniae por bloco do HIAE")
