...
bacteria_df = df[(df['ds_micro_organismo'] == 'Achromobacter gyllenbergii') & (df['cd_interpretacao_antibiograma'] == 'Resistente')]
st.title("Gráficos específico para Achromobacter Gyllenbergii Resistente")
...
bacteria_g = g[(g['ds_micro_organismo'] == 'Achromobacter gyllenbergii') & (g['cd_interpretacao_antibiograma'] == 'Resistente')]
st.title("Presença de Achromobacter Gyllenbergii por bloco do HIAE")
