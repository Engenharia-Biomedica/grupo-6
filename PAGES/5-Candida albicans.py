...
bacteria_df = df[(df['ds_micro_organismo'] == 'Candida albicans') & (df['cd_interpretacao_antibiograma'] == 'Resistente')]
st.title("Gráficos específico para Candida Albicans Resistente")

colunas_validas = ['ds_unidade_coleta', 'dh_coleta_exame', ]

coluna_analise = st.selectbox("Selecione a coluna de análise:", colunas_validas)
...
bacteria_g = g[(g['ds_micro_organismo'] == 'Candida albicans') & (g['cd_interpretacao_antibiograma'] == 'Resistente')]
st.title("Presença de Candida Albicans por bloco do HIAE")
