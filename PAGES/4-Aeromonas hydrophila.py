...
bacteria_df = df[(df['ds_micro_organismo'] == 'Aeromonas hydrophila') & (df['cd_interpretacao_antibiograma'] == 'Resistente')]
st.title("Gráficos específico para Aeromonas Hidrophila Resistente")
...
bacteria_g = g[(g['ds_micro_organismo'] == 'Aeromonas hidrophila') & (g['cd_interpretacao_antibiograma'] == 'Resistente')]
st.title("Presença de Aeromonas Hidrophila por bloco do HIAE")
