...
bacteria_df = df[(df['ds_micro_organismo'] == 'Achromobacter xylosoxidans') & (df['cd_interpretacao_antibiograma'] == 'Resistente')]
st.title("Gráficos específico para Achromobacter Xylosoxidans Resistente")
...
coluna_interpretacao = 'cd_interpretacao_antibiograma'  
...
if coluna_analise:
    ...
    st.warning("Selecione a coluna de análise.")
    
file = "HIAE.csv"
g = pd.read_csv(file,sep = ";")

bacteria_g = g[(g['ds_micro_organismo'] == 'Achromobacter xylosoxidans') & (g['cd_interpretacao_antibiograma'] == 'Resistente')]
st.title("Presença de Achromobacter Xylosoxidans por bloco do HIAE")
